...
$vnet2 = New-AzVirtualNetwork -Name vNet1 -ResourceGroupName "mod5demo2-rg" -Location "australiaeast" -AddressPrefix "10.0.1.0/24" -Subnet $vnet2subnet1,$vnet2gwsubnet
